...
export default async function ReviewDiagnosisPage({ params }: { params: { id: string } }) {
  const { userId } = auth()
      ...
      <DashboardLayout role="doctor">
        <div className="space-y-6">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-2xl font-bold tracking-tight">Review Diagnosis</h2>
          </div>

          <Card>
            <CardHeader>
              <CardTitle>Review and Provide Professional Assessment</CardTitle>
              <CardDescription>Review the AI diagnosis and provide your professional assessment.</CardDescription>
            </CardHeader>
            <CardContent>
              <DoctorReviewForm
